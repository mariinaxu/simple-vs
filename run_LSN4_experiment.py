...
if __name__ == "__main__":
    try:
        print("Running a 4 degree receptive field mapping experiment.")
        ...
        exp = LocallySparseNoiseExperiment(experiment_id, mouse_id, data_aq, "monitor_config.yaml", "save_settings_config.yaml", "locally_sparse_noise_4deg_config.yaml", debug=bool_DEBUG)
